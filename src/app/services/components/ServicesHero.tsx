  ...
  return (
    <section className="relative pt-14 pb-20 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <svg className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-28 sm:h-36 lg:h-48 opacity-50" viewBox="0 0 1 192" fill="none" preserveAspectRatio="none"><line x1="0.5" y1="0" x2="0.5" y2="192" stroke="url(#lineGradServices)" strokeWidth="1" /><defs><linearGradient id="lineGradServices" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#0F2854" stopOpacity="0" /><stop offset="50%" stopColor="#0F2854" stopOpacity="1" /><stop offset="100%" stopColor="#0F2854" stopOpacity="0" /></linearGradient></defs></svg>
