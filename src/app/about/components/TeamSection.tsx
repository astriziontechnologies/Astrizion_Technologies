    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-[#0F2854]/70 text-lg max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          {team.map((member, i) => (
            <motion.div
              ...
              className="group text-center p-4 sm:p-6 rounded-2xl border border-[#0F2854]/15 bg-white hover:border-[#0F2854]/35 hover:bg-[#0F2854]/5 transition-all duration-300"
            >
              {/* Avatar */}
              <div className="w-14 h-14 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-[#1C4D8D] to-[#0F2854] flex items-center justify-center mx-auto mb-3 sm:mb-4 group-hover:shadow-lg group-hover:shadow-[#0F2854]/20 transition-all duration-300">
              ...
              <p className="text-[#0F2854]/60 text-xs mb-4">{member.role}</p>
              <div className="flex justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                <a href="#" className="w-7 h-7 rounded-lg bg-[#0F2854]/10 flex items-center justify-center text-[#0F2854]/50 hover:text-[#0F2854] transition-colors">
                  <Linkedin size={13} />
                </a>
                <a href="#" className="w-7 h-7 rounded-lg bg-[#0F2854]/10 flex items-center justify-center text-[#0F2854]/50 hover:text-[#0F2854] transition-colors">
                  <Twitter size={13} />
